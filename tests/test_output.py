...
def test_json():
    ...
    assert list(formatted_as_json.iter_encoded()) == [b'{"meta": {"run_id": ["mockrun"], "rev_id": "fakerev", "query_id": "fakequery"}, "headers": ["id", "text", "query_database", "query_id"], "rows": [[1, "show tables;", "quarry", 2], [2, "select * from query_revision;", "quarry", 5]]}']  # noqa: E501
...
def test_json_lines():
    ...
    assert list(formatted_as_json_lines.iter_encoded()) == [b'{"id": 1, "text": "show tables;", "query_database": "quarry", "query_id": 2}', b'\n', b'{"id": 2, "text": "select * from query_revision;", "query_database": "quarry", "query_id": 5}', b'\n']  # noqa E501
...
def test_csv():
    ...
    assert list(formatted_as_csv.iter_encoded()) == [b'id,text,query_database,query_id\r\n1,show tables;,quarry,2\r\n2,select * from query_revision;,quarry,5\r\n']  # noqa: E501
...
def test_tsv():
    ...
    assert list(formatted_as_tsv.iter_encoded()) == [b'id\ttext\tquery_database\tquery_id\r\n1\tshow tables;\tquarry\t2\r\n2\tselect * from query_revision;\tquarry\t5\r\n']  # noqa: E501
...
def test_wikitable():
    ...
    assert list(formatted_as_wikitable.iter_encoded()) == [b'{| class="wikitable"', b'\n', b'!id!!text!!query_database!!query_id', b'\n', b'|-', b'\n', b'|1||show tables;||quarry||2', b'\n', b'|-', b'\n', b'|2||select * from query_revision;||quarry||5', b'\n', b'|}', b'\n']  # noqa: E501
...
def test_html():
    ...
    assert list(formatted_as_html.iter_encoded()) == [b'<table>\n', b'\n', b'<tr>', b'\n', b'<th scope="col">id</th>', b'\n', b'<th scope="col">text</th>', b'\n', b'<th scope="col">query_database</th>', b'\n', b'<th scope="col">query_id</th>', b'\n', b'</tr>\n', b'\n', b'<tr>', b'\n', b'<td>1</td>', b'\n', b'<td>show tables;</td>', b'\n', b'<td>quarry</td>', b'\n', b'<td>2</td>', b'\n', b'</tr>\n', b'\n', b'<tr>', b'\n', b'<td>2</td>', b'\n', b'<td>select * from query_revision;</td>', b'\n', b'<td>quarry</td>', b'\n', b'<td>5</td>', b'\n', b'</tr>\n', b'\n', b'</table>', b'\n']  # noqa: $501
...
def test_invalid_format():
    ...
    assert list(formatted_as_invalid.iter_encoded()) == [b'Bad file format']  # noqa: E501
